      ...
      <AnimatePresence mode="wait">
        {!isExpanded ? (
          <motion.div
            ...
            className={cn(
              'w-[360px] h-[72px] rounded-xl cursor-move',
          ...
          >
            {/* 头部 */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-border/40 bg-gradient-to-r from-primary/10 via-transparent to-accent/10">
              <div className="flex items-center gap-2">
